...
public class MainFrame extends JFrame {
     ...
     */
    public MainFrame(String title, TravellingAgencyController travellingAgencyController, RegularUserController regularUserController)
    {
        super(title);
        ...
        panels = new JPanel[4];
        panels[0]=new LogInView(screenHeight, screenWidth, regularUserController, travellingAgencyController, this);
    ...
    public JPanel getPanel(int panelNumber){
        if(panelNumber<this.panels.length)
            return this.panels[panelNumber];
        return null;
    }
}
